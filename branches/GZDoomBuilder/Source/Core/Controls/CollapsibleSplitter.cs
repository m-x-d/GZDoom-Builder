...
namespace CodeImp.DoomBuilder.Controls
{
	...
	public class CollapsibleSplitter : Splitter
	{
		...
		public event EventHandler CollapsedChanged; //mxd
		...
		{
			get { return (this.controlToHide == null || !this.controlToHide.Visible); } //mxd
			set { if(this.controlToHide != null) ToggleSplitter(value); } //mxd
		}
		...
		{
			this.ToggleSplitter(controlToHide.Visible);
		}
		...
		private void OnClick(object sender, EventArgs e)
		{
			...
			{
				ToggleSplitter(controlToHide.Visible);
			}
		}

		private void ToggleSplitter(bool collapse)
		{
