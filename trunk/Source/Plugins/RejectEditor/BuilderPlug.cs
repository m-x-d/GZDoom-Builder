...
namespace CodeImp.DoomBuilder.Plugins.RejectEditor
{
	public class BuilderPlug : Plug
	{
		...
		public override void OnMapNodesRebuilt()
		{
			...
			{
				General.ErrorLogger.Add(ErrorType.Error, "Unable to find the REJECT table. Check your nodebuilder settings and make sure you are using a nodebuilder that generates a reject table.");
				return;
			}
			...
			{
				General.ErrorLogger.Add(ErrorType.Error, "The nodebuilder is generating an invalid REJECT table. Check your nodebuilder settings and make sure you are using a nodebuilder that generates a proper reject table.");
				return;
			}
